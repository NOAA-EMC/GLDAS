...
!     SFCPRS = PRESSURE AT LOWEST MODEL LAYER (SIGMA 0.9973)
      REAL(kind=kind_phys):: SFCPRS,SFCSPD,SFCTMP,
     &   SFCQ,SKINT,Z0,CM2,CH2

! GFS_SFC_DIFF CALL VARIABLES
      INTEGER IM,sfc_z0_type,ivegsrc,vegtypi
      integer vegtyp(1)
      REAL (kind=kind_phys)::U1,V1,Z1I
      REAL(kind=kind_phys):: PS(1),T1(1),Q1(1),Z1(1),
     &     TSKIN,Z0RL,CM,CH,RB,
...
! 1 - land, 2 - ice, 3 - water
      real(kind=kind_phys):: tskin3(3), tsurf3(3), snwdph3(3),
